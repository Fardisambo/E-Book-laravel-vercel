...
<div class="space-y-6">
    <div class="glass-panel rounded-3xl border border-white/10 p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?php echo e(route('author.borrows.index')); ?>" class="text-amber-300 hover:underline">Kembali ke daftar</a>
        </div>
        ...
        <form action="<?php echo e(route('author.borrows.update', $borrow->id)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="flex flex-wrap gap-4">
                ...
                <a href="<?php echo e(route('author.borrows.index')); ?>" class="inline-flex items-center justify-center rounded-full border border-white/10 px-6 py-3 text-sm text-gray-300 hover:bg-white/5 transition">Batal</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel\laravel_ebook\resources\views/author/borrows/show.blade.php ENDPATH**/ ?>