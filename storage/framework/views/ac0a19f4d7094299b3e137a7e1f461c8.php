...
<div class="max-w-2xl">
    ...
    <form action="<?php echo e(route('admin.users.update', $user->id)); ?>" method="POST" class="ui-card p-6">
        <?php echo csrf_field(); ?>
        ...
        <div class="mt-6 flex space-x-4">
            ...
            <a href="<?php echo e(route('admin.users.index')); ?>" class="bg-white-200 text-white-700 px-6 py-2 rounded-lg hover:bg-white-300 transition-colors">
                Batal
            </a>
        </div>
    </form>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel_ebook\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>