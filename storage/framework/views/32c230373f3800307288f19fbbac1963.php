...
<head>
    ...
    <style>
        ...
        body.admin-layout .bg-white {
            background-color: rgba(255, 255, 255, 0.05) !important;
        }
        body.admin-layout .bg-gray-50,
        body.admin-layout .bg-gray-100,
        body.admin-layout .bg-gray-200,
        body.admin-layout .bg-gray-300 {
            background-color: rgba(255, 255, 255, 0.06) !important;
        }
        body.admin-layout .border-gray-200,
        body.admin-layout .border-gray-300,
        body.admin-layout .border-gray-400 {
            border-color: rgba(255, 255, 255, 0.12) !important;
        }
        body.admin-layout .text-gray-900,
        body.admin-layout .text-gray-800,
        body.admin-layout .text-black {
            color: #f8fafc !important;
        }
        body.admin-layout .text-gray-700,
        body.admin-layout .text-gray-600,
        body.admin-layout .text-gray-500 {
            color: #cbd5e1 !important;
        }
        body.admin-layout .placeholder-gray-400 {
        ...
        body.admin-layout .hover\:bg-gray-50:hover {
            ...
            <div>
                ...
                <nav class="space-y-2 text-sm">
                    ...
                    <a href="<?php echo e(route('admin.borrows.index')); ?>"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg transition-all
                              <?php echo e(request()->routeIs('admin.borrows.*') ? 'bg-white/5 text-amber-200/90 active' : 'text-gray-400 hover:text-amber-200/90 hover:bg-white/5'); ?>">
                        <i data-lucide="book-open" class="w-5 h-5"></i>
...
<?php /**PATH D:\laragon\www\laravel\laravel_ebook\resources\views/layouts/admin.blade.php ENDPATH**/ ?>