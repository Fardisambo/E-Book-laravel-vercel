                ...
                <nav class="space-y-2 text-sm">
                    <a href="<?php echo e(route('books.index')); ?>"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg transition-all
                              <?php echo e(request()->routeIs('books.index') ? 'bg-white/5 text-amber-200/90 active' : 'text-gray-400 hover:text-amber-200/90 hover:bg-white/5'); ?>">
                    ...
                    <a href="<?php echo e(route('books.browse')); ?>"
                       class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg transition-all
                              <?php echo e(request()->routeIs('books.browse') ? 'bg-white/5 text-amber-200/90 active' : 'text-gray-400 hover:text-amber-200/90 hover:bg-white/5'); ?>">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('orders.paid')); ?>"
                           class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg transition-all
                           <?php echo e(request()->routeIs('orders.paid') ? 'bg-white/5 text-amber-200/90 active' : 'text-gray-400 hover:text-amber-200/90 hover:bg-white/5'); ?>">
                        ...
                        <a href="<?php echo e(route('orders.unpaid')); ?>"
                           class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg transition-all
                            <?php echo e(request()->routeIs('orders.unpaid') ? 'bg-white/5 text-amber-200/90 active' : 'text-gray-400 hover:text-amber-200/90 hover:bg-white/5'); ?>">
                        ...
                        <a href="<?php echo e(route('subscriptions.index')); ?>"
                           class="sidebar-link flex items-center gap-3 px-4 py-3 rounded-lg transition-all 
                            <?php echo e(request()->routeIs('subscriptions.*') ? 'bg-white/5 text-amber-200/90 active' : 'text-gray-400 hover:text-amber-200/90 hover:bg-white/5'); ?>">
        ...
        <main class="flex-1 overflow-y-auto scrollbar-hide">
            ...
            <div class="p-4 sm:p-8 max-w-7xl mx-auto space-y-4 sm:space-y-8">
                ...
                <footer class="pt-8 pb-4 text-center text-xs text-gray-500">
                    &copy; <?php echo e(date('Y')); ?> Lumière E-Library. Dibuat dengan Laravel.
                </footer>
            </div>
        </main>
    </div>
...
<?php /**PATH C:\laragon\www\laravel\laravel_ebook\resources\views/layouts/app.blade.php ENDPATH**/ ?>