                    ...
                    <tbody class="divide-y divide-white/10">
                        <?php $__currentLoopData = $borrows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b border-white/5">
                                ...
                                <td class="px-4 py-3">
                                    <a href="<?php echo e(route('admin.borrows.show', $borrow->id)); ?>" class="text-amber-300 hover:underline">Lihat</a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel\laravel_ebook\resources\views/admin/borrows/index.blade.php ENDPATH**/ ?>