...
<div class="max-w-6xl mx-auto px-4 py-8 space-y-6">
    ...
    <div class="grid md:grid-cols-2 gap-6">
        <div class="ui-card rounded-2xl p-6 sm:p-8 ">
            ...
            <div class="mb-5">
                <span class="text-3xl sm:text-4xl font-semibold text-amber-300">Rp <?php echo e(number_format($plans['monthly']->price ?? 50000, 0, ',', '.')); ?></span>
                <span class="text-gray-400 text-sm">/bulan</span>
            </div>
            <p class="text-sm text-gray-300 mb-4"><?php echo e($plans['monthly']->description ?? 'Akses membaca semua buku tanpa batas selama 1 bulan.'); ?></p>
        ...
        <div class="ui-card rounded-2xl p-6 sm:p-8 border border-amber-500/50 relative">
            ...
            <div class="mb-5">
                <span class="text-3xl sm:text-4xl font-semibold text-amber-300">Rp <?php echo e(number_format($plans['yearly']->price ?? 500000, 0, ',', '.')); ?></span>
            ...
            <p class="text-sm text-gray-300 mb-4"><?php echo e($plans['yearly']->description ?? 'Akses membaca semua buku tanpa batas selama 1 tahun dengan harga hemat.'); ?></p>
            <ul class="space-y-3 mb-6 text-sm text-gray-200">
                <li class="flex items-center gap-2">
                    <i data-lucide="check" class="w-4 h-4 text-emerald-300"></i>
                    Akses membaca semua buku
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel_ebook\resources\views/subscriptions/index.blade.php ENDPATH**/ ?>