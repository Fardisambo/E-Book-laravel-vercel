...
<div class="max-w-2xl">
    <h1 class="text-3xl font-bold text-white-900 mb-6">Edit Kategori</h1>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4"
                    class="w-full px-4 py-2 border border-white-300 rounded-lg focus:ring-2 focus:ring-[#FF2D20] focus:border-transparent"><?php echo e(old('description', $category->description)); ?></textarea>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel_ebook\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>