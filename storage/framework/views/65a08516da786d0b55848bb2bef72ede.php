...
<div class="flex flex-col gap-6">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
            <h1 class="text-3xl font-semibold text-white">Buku</h1>
            <p class="mt-2 text-sm text-gray-400">Kelola daftar buku, status publikasi, dan informasi lengkap buku.</p>
        </div>
        <a href="<?php echo e(route('admin.books.create')); ?>" class="inline-flex items-center justify-center rounded-full bg-amber-400 px-5 py-3 text-sm font-semibold text-black hover:bg-amber-300 transition">+ Tambah Buku</a>
    </div>

    <div class="glass-panel rounded-[28px] border border-white/10 overflow-hidden shadow-2xl">
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-white/10">
                ...
                <tbody class="divide-y divide-white/10 bg-[#090909]">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel\laravel_ebook\resources\views/admin/books/index.blade.php ENDPATH**/ ?>