        ...
        <tbody class="bg-white divide-y divide-white-200">
            ...
            <tr>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-white-900">#<?php echo e($purchase->id); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-white-900"><?php echo e($purchase->user->name); ?></div>
                    <div class="text-xs text-white-500"><?php echo e($purchase->user->email); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-white-900"><?php echo e($purchase->book->title); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-white-900">Rp <?php echo e(number_format($purchase->price, 0, ',', '.')); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-white-500"><?php echo e($purchase->created_at->format('d M Y')); ?></div>
                </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel_ebook\resources\views/admin/purchases/index.blade.php ENDPATH**/ ?>