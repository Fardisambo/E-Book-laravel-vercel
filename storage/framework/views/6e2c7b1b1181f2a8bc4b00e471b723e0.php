...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <form action="<?php echo e(route('admin.books.update', $book->id)); ?>" method="POST" enctype="multipart/form-data" class="glass-panel rounded-[32px] border border-white/10 p-8 shadow-2xl">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="library_total_copies" id="library_total_copies"
                    class="w-full rounded-3xl bg-white/5 border border-white/10 px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-400"
                    value="<?php echo e(old('library_total_copies', $book->library_total_copies ?? 0)); ?>">
                <?php $__errorArgs = ['library_total_copies'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" id="description" rows="4"
                    class="w-full rounded-3xl bg-white/5 border border-white/10 px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-400"><?php echo e(old('description', $book->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <?php if($book->cover_url): ?>
                    <div class="mb-3">
                        <img src="<?php echo e(asset('storage/' . $book->cover_url)); ?>" alt="Current cover" class="w-32 h-48 rounded-3xl object-cover border border-white/10">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="md:col-span-2 flex flex-wrap gap-4 items-center">
                <label class="inline-flex items-center gap-2 text-gray-300">
                    <input type="checkbox" name="is_featured" value="1" <?php echo e(old('is_featured', $book->is_featured) ? 'checked' : ''); ?> class="h-4 w-4 rounded border-white/10 bg-white/5 text-amber-400 focus:ring-amber-400">
                    Featured
                </label>
                <label class="inline-flex items-center gap-2 text-gray-300">
                    <input type="checkbox" name="is_published" value="1" <?php echo e(old('is_published', $book->is_published) ? 'checked' : ''); ?> class="h-4 w-4 rounded border-white/10 bg-white/5 text-amber-400 focus:ring-amber-400">
                    Published
                </label>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel\laravel_ebook\resources\views/admin/books/edit.blade.php ENDPATH**/ ?>