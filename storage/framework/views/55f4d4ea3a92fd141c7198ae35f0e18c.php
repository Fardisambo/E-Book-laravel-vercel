...
<div class="mb-6">
    ...
    <h1 class="text-3xl font-bold text-white-900 mt-2">Detail Pesanan #<?php echo e($purchase->id); ?></h1>
</div>
        ...
        <div class="ui-card p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-lg text-white-900"><?php echo e($purchase->id); ?></p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-lg text-white-900"><?php echo e($purchase->created_at->format('d M Y H:i')); ?></p>
                </div>
                <div>
                    <label class="text-sm font-medium text-gray-500">Harga</label>
                    <p class="text-lg font-bold text-white-900">Rp <?php echo e(number_format($purchase->price, 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="ui-card p-6 mt-6">
            ...
            <div class="space-y-3">
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-white-900">Rp <?php echo e(number_format($purchase->price, 0, ',', '.')); ?></span>
                </div>
                <?php
                ...
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-white-900">Rp <?php echo e(number_format($totalPayments, 0, ',', '.')); ?></span>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel_ebook\resources\views/admin/purchases/show.blade.php ENDPATH**/ ?>