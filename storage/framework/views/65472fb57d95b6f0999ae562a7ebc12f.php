            ...
            <div class="grid sm:grid-cols-2 gap-4">
                <div class="sm:col-span-2">
                    ...
                    <input
                        ...
                        required
                        class="w-full px-3 py-2.5 rounded-xl bg-black/40 border border-white/10 text-sm text-gray-100 placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-amber-500/70 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="sm:col-span-2">
                    ...
                    <input
                        ...
                        required
                        class="w-full px-3 py-2.5 rounded-xl bg-black/40 border border-white/10 text-sm text-gray-100 placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-amber-500/70 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500/60 <?php unset($message);
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            name="password"
                            type="password"
                            class="w-full px-3 py-2.5 rounded-xl bg-black/40 border border-white/10 text-sm text-gray-100 placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-amber-500/70 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500/60 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="password"
                            class="w-full px-3 py-2.5 rounded-xl bg-black/40 border border-white/10 text-sm text-gray-100 placeholder-gray-600 focus:outline-none focus:ring-1 focus:ring-amber-500/70"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel\laravel_ebook\resources\views/profile/edit.blade.php ENDPATH**/ ?>