    ...
    <div class="w-full max-w-5xl grid gap-10 lg:grid-cols-2">
        ...
        <div class="ui-card rounded-[32px]  p-10 shadow-2xl">
            <div class="text-center mb-8">
                ...
                <p class="mt-3 text-sm text-gray-400">Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="font-semibold text-amber-300 hover:text-amber-200">Daftar sekarang</a></p>
            </div>
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input id="email" name="email" type="email" required
                            class="w-full rounded-2xl bg-white/5  px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400 <?php $__errorArgs = ['email'];
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="password" name="password" type="password" required
                                class="w-full rounded-2xl bg-white/5  px-4 py-3 pr-12 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel_ebook\resources\views/auth/login.blade.php ENDPATH**/ ?>