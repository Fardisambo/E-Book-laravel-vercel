...
<div class="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center mb-6">
    ...
    <a href="<?php echo e(route('admin.users.create')); ?>" class="ui-btn-primary">
        + Tambah User
    </a>
</div>
        ...
        <tbody class="bg-white divide-y divide-white-200">
            ...
            <tr>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-white-900"><?php echo e($user->name); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-white-900"><?php echo e($user->email); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="px-2 py-1 text-xs font-semibold rounded-full 
                        <?php echo e($user->role === 'admin' ? 'bg-purple-100 text-purple-800' : 'bg-white-100 text-white-800'); ?>">
                        <?php echo e($user->role === 'author' ? 'Petugas' : ucfirst($user->role)); ?>

                    </span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-white-900"><?php echo e($user->purchases_count); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-white-900"><?php echo e($user->subscriptions_count); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="text-amber-400 hover:text-amber-300 mr-4">Edit</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel_ebook\resources\views/admin/users/index.blade.php ENDPATH**/ ?>