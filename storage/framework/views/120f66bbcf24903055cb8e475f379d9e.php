    ...
    <div class="flex h-full gap-3 sm:gap-4">
            ...
            <div>
                ...
                <nav class="space-y-2 text-sm">
                    ...
                    <a href="<?php echo e(route('admin.books.index')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.books.*') ? 'bg-white/10 text-white' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                        <i data-lucide="book-open" class="w-5 h-5"></i>
                        <span>Buku</span>
                    </a>

                    <a href="<?php echo e(route('admin.borrows.index')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.borrows.*') ? 'bg-white/10 text-white' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                        <i data-lucide="book-open" class="w-5 h-5"></i>
                        <span>Pinjaman Buku</span>
                    </a>

                    <a href="<?php echo e(route('admin.categories.index')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-white/10 text-white' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                        <i data-lucide="grid-2x2" class="w-5 h-5"></i>
                        <span>Kategori</span>
                    </a>

                    <a href="<?php echo e(route('admin.users.index')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.users.*') ? 'bg-white/10 text-white' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                        <i data-lucide="users" class="w-5 h-5"></i>
                        <span>Users</span>
                    </a>

                    <a href="<?php echo e(route('admin.purchases.index')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.purchases.*') ? 'bg-white/10 text-white' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                        <i data-lucide="shopping-bag" class="w-5 h-5"></i>
                        <span>Pesanan Buku</span>
                    </a>

                    <a href="<?php echo e(route('admin.subscriptions.index')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.subscriptions.*') ? 'bg-white/10 text-white' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                        <i data-lucide="badge-check" class="w-5 h-5"></i>
                        <span>Langganan</span>
                    </a>

                    <a href="<?php echo e(route('admin.payment-methods.index')); ?>"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.payment-methods.*') ? 'bg-white/10 text-white' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
        ...
        <aside id="admin-mobile-sidebar" class="md:hidden fixed left-0 top-0 bottom-0 z-50 w-72 max-w-[88vw] ui-sidebar p-5 flex flex-col justify-between -translate-x-full transition-transform duration-200">
            <div>
                ...
                <nav class="space-y-2 text-sm">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
                        <i data-lucide="layout-dashboard" class="w-4 h-4"></i><span>Dashboard</span>
                    </a>
                    <a href="<?php echo e(route('admin.books.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.books.*') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
                        <i data-lucide="book-open" class="w-4 h-4"></i><span>Buku</span>
                    </a>
                    <a href="<?php echo e(route('admin.borrows.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.borrows.*') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
                        <i data-lucide="calendar-check" class="w-4 h-4"></i><span>Pinjaman Buku</span>
                    </a>
                    <a href="<?php echo e(route('admin.categories.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
                        <i data-lucide="grid-2x2" class="w-4 h-4"></i><span>Kategori</span>
                    </a>
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.users.*') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
                        <i data-lucide="users" class="w-4 h-4"></i><span>Users</span>
                    </a>
                    <a href="<?php echo e(route('admin.purchases.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.purchases.*') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
                        <i data-lucide="shopping-bag" class="w-4 h-4"></i><span>Pesanan Buku</span>
                    </a>
                    <a href="<?php echo e(route('admin.subscriptions.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.subscriptions.*') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
                        <i data-lucide="badge-check" class="w-4 h-4"></i><span>Langganan</span>
                    </a>
                    <a href="<?php echo e(route('admin.payment-methods.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition <?php echo e(request()->routeIs('admin.payment-methods.*') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
                        <i data-lucide="credit-card" class="w-4 h-4"></i><span>Metode Pembayaran</span>
                    </a>
                    <a href="<?php echo e(route('books.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition text-slate-400">
                ...
                <div class="ui-panel p-3 space-y-2">
                    ...
                    <a href="<?php echo e(route('admin.categories.index')); ?>" class="ui-btn-ghost w-full justify-start <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-white/10' : ''); ?>">
                        <i data-lucide="grid-2x2" class="w-4 h-4"></i>
                        Kategori
                    </a>
                    <a href="<?php echo e(route('admin.purchases.index')); ?>" class="ui-btn-ghost w-full justify-start <?php echo e(request()->routeIs('admin.purchases.*') ? 'bg-white/10' : ''); ?>">
                        <i data-lucide="shopping-bag" class="w-4 h-4"></i>
                        Pesanan Buku
                    </a>
                    <a href="<?php echo e(route('admin.subscriptions.index')); ?>" class="ui-btn-ghost w-full justify-start <?php echo e(request()->routeIs('admin.subscriptions.*') ? 'bg-white/10' : ''); ?>">
                        <i data-lucide="badge-check" class="w-4 h-4"></i>
                        Langganan
                    </a>
                    <a href="<?php echo e(route('admin.payment-methods.index')); ?>" class="ui-btn-ghost w-full justify-start <?php echo e(request()->routeIs('admin.payment-methods.*') ? 'bg-white/10' : ''); ?>">
        ...
        <main class="flex-1 overflow-y-auto">
            <header class="ui-topbar sticky top-0 z-20 px-3 sm:px-6 py-3 sm:py-4 flex items-center justify-between mb-4">
                <div>
                    ...
                    <h1 class="text-lg sm:text-xl font-semibold text-white"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
                </div>
            ...
            <nav class="md:hidden fixed bottom-3 left-3 right-3 ui-panel px-2 py-1.5 z-30">
                <div class="grid grid-cols-5 gap-1 text-[11px]">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex flex-col items-center py-2 rounded-lg <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
                        <i data-lucide="layout-dashboard" class="w-4 h-4 mb-1"></i>
                        <span>Dashboard</span>
                    </a>
                    <a href="<?php echo e(route('admin.books.index')); ?>" class="flex flex-col items-center py-2 rounded-lg <?php echo e(request()->routeIs('admin.books.*') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
                        <i data-lucide="book-open" class="w-4 h-4 mb-1"></i>
                        <span>Buku</span>
                    </a>
                    <a href="<?php echo e(route('admin.borrows.index')); ?>" class="flex flex-col items-center py-2 rounded-lg <?php echo e(request()->routeIs('admin.borrows.*') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
                        <i data-lucide="calendar-check" class="w-4 h-4 mb-1"></i>
                        <span>Pinjaman</span>
                    </a>
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="flex flex-col items-center py-2 rounded-lg <?php echo e(request()->routeIs('admin.users.*') ? 'bg-white/10 text-white' : 'text-slate-400'); ?>">
...
<?php /**PATH C:\laragon\www\laravel_ebook\resources\views/layouts/admin.blade.php ENDPATH**/ ?>