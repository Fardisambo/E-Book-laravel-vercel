        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e(number_format($stats['total_books'])); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">Rp <?php echo e(number_format($stats['total_revenue'], 0, ',', '.')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900"><?php echo e(number_format($stats['pending_payments'])); ?></p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="p-6">
                <div class="space-y-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-1">
                            <h3 class="font-medium text-gray-900"><?php echo e($book->title); ?></h3>
            ...
            <div class="p-6">
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-xs px-2 py-1 bg-gray-100 text-gray-600 rounded"><?php echo e($user->role); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\laravel\laravel_ebook\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>