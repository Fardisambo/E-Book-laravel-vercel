...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <form action="<?php echo e(route('admin.books.update', $book->id)); ?>" method="POST" enctype="multipart/form-data" class="ui-card rounded-[32px] border border-white/10 p-8 shadow-2xl">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel_ebook\resources\views/admin/books/edit.blade.php ENDPATH**/ ?>