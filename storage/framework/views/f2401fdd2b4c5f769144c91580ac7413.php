...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <form action="<?php echo e(route('admin.books.store')); ?>" method="POST" enctype="multipart/form-data" class="ui-card rounded-[32px] border border-white/10 p-5 sm:p-8 shadow-2xl">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="library_total_copies" id="library_total_copies"
                    ...
                    value="<?php echo e(old('library_total_copies', 0)); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" id="description" rows="4"
                    class="ui-textarea"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-8 flex flex-wrap gap-4">
            ...
            <a href="<?php echo e(route('admin.books.index')); ?>" class="ui-btn-ghost">Batal</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel_ebook\resources\views/admin/books/create.blade.php ENDPATH**/ ?>