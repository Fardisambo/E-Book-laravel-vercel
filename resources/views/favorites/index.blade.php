...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-400">
                Anda memiliki <span class="text-amber-400 font-semibold">{{ $favorites->total() }}</span> buku favorit
            </p>
        </div>
        <a href="{{ route('books.browse') }}" class="px-4 py-2 ui-btn-primary">
    ...
    <div class="grid gap-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        @forelse($favorites as $book)
            <div class="book-card ui-card rounded-2xl  overflow-hidden hover:border-amber-500/30 transition-all duration-300">
                <!-- Book Cover -->
                <a href="{{ route('books.show', $book->id) }}" class="relative h-52 sm:h-60 overflow-hidden block group">
                    <img
                ...
                <div class="p-4 space-y-2">
                    ...
                    <h3 class="font-medium text-sm sm:text-base text-white line-clamp-2">
                        <a href="{{ route('books.show', $book->id) }}" class="hover:text-amber-300 transition-colors">
                            {{ $book->title }}
                        </a>
                    </h3>
        ...
        @empty
            ...
            <div class="col-span-full">
                <div class="ui-card rounded-2xl p-12 text-center ">
