...
@section('title', 'Pesanan Sudah Dibayar')
...
<div class="max-w-6xl mx-auto px-4 py-8 space-y-6">
    <div class="flex items-center justify-between gap-3">
        ...
        <a href="{{ route('orders.unpaid') }}" class="text-xs sm:text-sm text-amber-300 hover:text-amber-200 flex items-center gap-1">
                ...
                @if($item['type'] === 'purchase')
                    ...
                    <div class="ui-card rounded-2xl border border-emerald-500/30 p-4 sm:p-5">
                        ...
                        <div class="mt-3 pt-3 border-t border-white/10 flex flex-wrap items-center justify-between gap-2 text-[11px] text-gray-500">
                            <span>
                                Dibeli pada {{ $purchase->created_at->format('d M Y H:i') }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="ui-card rounded-2xl border border-emerald-500/30 p-4 sm:p-5">
                            ...
                            <div class="md:col-span-2 flex gap-4 items-center">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-[11px] text-gray-500">
                                            Berlaku sampai {{ $subscription->expires_at->format('d M Y') }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-3 pt-3 border-t border-white/10 grid md:grid-cols-3 gap-3 text-[11px] text-gray-500">
                            <div>
                                ...
                                <p class="text-gray-200">{{ $subscription->created_at->format('d M Y H:i') }}</p>
                            </div>
                            <div>
        ...
        @else
            ...
            <div class="ui-card rounded-3xl  p-12 text-center space-y-4">
                ...
                <div class="flex flex-wrap gap-3 justify-center">
                    ...
                    <a href="{{ route('orders.unpaid') }}" class="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-white/5 text-gray-100 text-sm font-medium hover:bg-white/10 transition-all">
                        <i data-lucide="clock" class="w-4 h-4"></i>
